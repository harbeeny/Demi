...
interface Props {
  ...
  /** an unconsumed + sheet camera request; the search pane fires the camera
   *  once, acknowledges through onAutoAction, and reports a dismissed
   *  camera through onAutoCancel */
...
export function LogSheet({ open, onClose, searchMeals, busy, defaultMode = "fdc", forcedSlot = null, autoAction = null, onAutoAction, onAutoCancel, onLogDb, onLogEstimate, onLogFdc }: Props) {
